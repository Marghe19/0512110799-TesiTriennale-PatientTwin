...
class ClassIcpCvHelper(BaseIcpCvHelper, ClassifierMixin):
	...
	>>> from digital_patient.conformal.icp import IcpClassifier
	>>> from digital_patient.conformal.nc import ClassifierNc, MarginErrFunc
	>>> from digital_patient.conformal.evaluation import ClassIcpCvHelper
	>>> from digital_patient.conformal.evaluation import class_mean_errors
	>>> from digital_patient.conformal.evaluation import cross_val_score
	>>> data = load_iris()
	...
	def fit(self, x, y):
		...
		for train, cal in split.split(x, y):
...
class RegIcpCvHelper(BaseIcpCvHelper, RegressorMixin):
	...
	>>> from digital_patient.conformal.nc import RegressorNc, AbsErrorErrFunc
	>>> from digital_patient.conformal.evaluation import RegIcpCvHelper
	>>> from digital_patient.conformal.evaluation import reg_mean_errors
	>>> from digital_patient.conformal.evaluation import cross_val_score
	>>> data = load_boston()
