...
class ClassIcpCvHelper(BaseIcpCvHelper, ClassifierMixin):
    ...
    >>> from backend.digital_patient import IcpClassifier
    >>> from backend.digital_patient import ClassifierNc, MarginErrFunc
    >>> from backend.digital_patient import ClassIcpCvHelper
    >>> from backend.digital_patient import class_mean_errors
    >>> from backend.digital_patient import cross_val_score
    >>> data = load_iris()
...
class RegIcpCvHelper(BaseIcpCvHelper, RegressorMixin):
    ...
    >>> from backend.digital_patient import IcpRegressor
    >>> from backend.digital_patient import RegressorNc, AbsErrorErrFunc
    >>> from backend.digital_patient import RegIcpCvHelper
    >>> from backend.digital_patient import reg_mean_errors
    >>> from backend.digital_patient import cross_val_score
    >>> data = load_boston()
